...
class ControllerCommonHome extends Controller {
    public function index() {
        ...
        foreach ($results as $result) {
            ...
            $this -> data['orders'][] = array('order_id' => $result['order_id'], 'customer' => $result['customer'], 'status' => $result['status'], 'date_added' => date($this -> language -> get('date_format_short'), strtotime($result['date_added'])), 'total' => $this -> currency -> format($result['total'], $result['currency_code'], $result['currency_value']), 'action' => $action);
        }
    ...
    public function login() {
        ...
        $ignore = array('common/login', 'common/forgotten', 'common/reset');
        ...
        if (isset($this -> request -> get['route'])) {
            $ignore = array('common/login', 'common/logout', 'common/forgotten', 'common/reset', 'error/not_found', 'error/permission');
    ...
    public function permission() {
        if (isset($this -> request -> get['route'])) {
            ...
            $ignore = array('common/home', 'common/login', 'common/logout', 'common/forgotten', 'common/reset', 'error/not_found', 'error/permission');
